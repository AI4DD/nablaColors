...
def get_parser(desc, default_task="test"):
    ...
    parser.add_argument("--head-pretrain", action="store_true", help="pretrain the energy head with freezed backbone")
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--chemprop-weight-path', type=str,
                       help="chemprop weights path to finetune")    # modif
