...
from unicore.utils import get_activation_fn, permute_final_dims
...
class AtomFeature(nn.Module):
    ...
    def forward(self, batched_data):
        ...
        solvent_embed = batched_data["solvent_embed"].unsqueeze(1)
        ...
        graph_token_feature = graph_token_feature + solvent_embed
